...
def reg_contact(message):
    ...
    bot.send_message(chat_id = -1001340620848, text = "НОВАЯ ЗАЯВКА ОТ БОТА ПРЕЗЕНТАЦИЙ: " + "Тема презентации: " + tema + "; Источники информации: " + istoki + "; Объём работы: " + objom + "; Срок Выполнени: " + data + "; Клиент: "+ contact + ";")
